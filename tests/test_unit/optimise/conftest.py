    ...
    return SurplusSummary(
        ...
        surplus_per_genotype={
            (Genotype.HET, Genotype.HET): GenotypeSurplus(
                ...
                total_male=190.34625,
                total_female=190.34625,
